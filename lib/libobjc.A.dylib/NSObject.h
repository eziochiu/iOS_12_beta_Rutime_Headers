...
@interface NSObject <ATXScoreLogSerializable, CAAnimatableValue, CARenderValue, CKLParsedObject, NSObject, NSRemoteInvocationInterface, PQLResultSetInitializer, _DKProtobufConverting> {
    Class  isa;
}
