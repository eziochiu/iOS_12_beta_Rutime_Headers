...
@interface SPUISearchViewController : UIViewController <APUIShortLookViewControllerDelegate, SFFeedbackListener, SPUIResultViewDelegate, SPUISearchHeaderDelegate, SearchUIFirstTimeExperienceDelegate, SearchUIResultViewDelegate, UIGestureRecognizerDelegate> {
