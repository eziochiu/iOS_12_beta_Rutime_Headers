...
@interface HMDHAPAccessory : HMDAccessory <HAPRelayAccessoryDelegate, HMDAccessoryIdentify, HMDAccessoryMinimumUserPrivilegeCapable, HMDTimeInformationMonitorDelegate, HMFTimerDelegate> {
...
- (void)_evaluateLocalOperationWithCompletion:(id /* block */)arg1;
