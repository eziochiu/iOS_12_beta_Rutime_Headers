...
@interface SBUIPasscodeLockViewBase : UIView <SBFLegibilitySettingsProviderDelegate, SBUIBiometricResourceObserver, SBUIPasscodeBiometricAuthenticationViewDelegate, SBUIPasscodeBiometricAuthenticationViewLayoutDelegate, SBUIPasscodeLockView, SBUIPasscodeLockView_Internal> {
...
@property (nonatomic, retain) SBUIProudLockContainerView *overrideProudLockContainerView;
...
- (void)layoutSubviews;
- (id)overrideProudLockContainerView;
- (id)passcode;
...
- (void)setOverrideProudLockContainerView:(id)arg1;
