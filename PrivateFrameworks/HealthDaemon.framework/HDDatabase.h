...
@property (nonatomic, retain) NSLock *writerConnectionLock;
...
- (bool)_waitForJournalMergesWithType:(long long)arg1 error:(id*)arg2;
...
- (void)setWriterConnectionLock:(id)arg1;
