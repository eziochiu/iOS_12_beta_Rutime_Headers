...
@property (nonatomic) unsigned long long tc_disconnectedReason;
@property (nonatomic, readonly) NSMutableArray *tc_events;
...
- (void)setTc_disconnectedReason:(unsigned long long)arg1;
- (unsigned long long)tc_disconnectedReason;
- (id)tc_events;
