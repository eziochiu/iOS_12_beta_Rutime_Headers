...
@property (nonatomic, retain) AVPlayerLayer *demoPlayerLayer;
...
@property (nonatomic, retain) UIView *playerLayerContainerView;
...
- (void)setDemoPlayerLayer:(id)arg1;
...
- (void)setPlayerLayerContainerView:(id)arg1;
