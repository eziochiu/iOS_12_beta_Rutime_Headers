...
@interface WBUFormAutoCompleteState : NSObject <CNContactPickerDelegate, SFCredentialProviderExtensionManagerObserver, WBUContactAutoFillViewControllerFiller, WBUCreditCardCaptureViewControllerDelegate, _ASCredentialProviderExtensionViewControllerDelegate, _ASPasswordCredentialAuthenticationViewControllerDelegate> {
