...
@interface CSSpeechManager : NSObject <CSAlarmMonitorDelegate, CSAssetManagerDelegate, CSAudioRecorderDelegate, CSAudioServerCrashMonitorGibraltarDelegate, CSLanguageCodeUpdateMonitorDelegate, CSSiriEnabledMonitorDelegate, CSStateMachineDelegate, CSTimerMonitorDelegate, CSVoiceTriggerDelegate, CSVolumeMonitorDelegate> {
