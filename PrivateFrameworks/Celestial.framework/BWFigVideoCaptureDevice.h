...
@interface BWFigVideoCaptureDevice : BWCaptureDevice <BWZoomCompletionDelegate> {
    ...
    unsigned long long  _lastStillCaptureFlags;
    int  _lastStillCaptureType;
    float  _lensPosition;
    ...
    bool  _maxExposureDurationHasBeenOverridden;
...
- (id)_initWithFigCaptureDeviceRef:(struct OpaqueFigCaptureDevice { }*)arg1 attributes:(id)arg2 synchronizedStreamsAttributes:(id)arg3 forPID:(int)arg4 createAutofocusSampleBufferProcessorFunction:(int (*)arg5 cameraParameters:(id)arg6 deviceVendorClass:(id)arg7 errOut:(int*)arg8;
...
- (void)_updateMaxExposureDuration;
...
- (bool)hasFlash;
- (id)initWithAttributes:(id)arg1 synchronizedStreamsAttributes:(id)arg2 forPID:(int)arg3 stealingBehavior:(int)arg4 clientIDOut:(int*)arg5 errOut:(int*)arg6 deviceAvailabilityChangedHandler:(id /* block */)arg7;
