...
@interface CKFullScreenCardAppViewController : UIViewController <CKBrowserViewControllerProtocol, CKFullScreenAppViewControllerProtocol, UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate> {
    UIView * _contentView;
