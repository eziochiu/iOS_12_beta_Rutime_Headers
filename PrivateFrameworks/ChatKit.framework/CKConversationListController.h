...
@interface CKConversationListController : UITableViewController <CKCloudKitSyncProgressViewControllerDelegate, CKConversationListCellDelegate, CKConversationResultsControllerDelegate, CKTranscriptPreviewControllerDelegate, IMCloudKitEventHandler, TUConversationManagerDelegate, UIActionSheetDelegate, UISearchBarDelegate, UISearchControllerDelegate, UITableViewDataSource, UITableViewDelegate, UITableViewDragDestinationDelegate, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Private> {
...
@property (nonatomic, retain) TUConversationManager *liveConversationManager;
...
- (bool)hasLiveRemoteConversationParticipantsForConversation:(id)arg1;
- (id)init;
- (id)inputAccessoryView;
- (void)invalidateCellLayout;
- (bool)isShowingSwipeDeleteConfirmation;
- (bool)isVisible;
- (id)liveConversationManager;
- (void)loadView;
...
- (void)setLiveConversationManager:(id)arg1;
