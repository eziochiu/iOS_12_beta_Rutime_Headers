...
@interface NCNotificationListViewController : UICollectionViewController <NCNotificationListCellDelegate, NCNotificationListCollectionViewDelegate, NCNotificationManagementControllerSettingsDelegate, NCNotificationViewControllerDelegatePrivate, UIGestureRecognizerDelegate> {
...
- (void)_setDeliverQuietly:(bool)arg1 forNotificationRequest:(id)arg2 withSectionIdentifier:(id)arg3 subSectionIdentifier:(id)arg4;
...
- (void)notificationListCellRequestsPresentingQuickSettings:(id)arg1 completion:(id /* block */)arg2;
