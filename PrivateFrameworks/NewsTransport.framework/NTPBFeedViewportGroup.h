...
@property (nonatomic, readonly) bool hasSpecialEventsConfig;
...
@property (nonatomic, retain) NTPBSpecialEventsConfig *specialEventsConfig;
...
- (void)setSpecialEventsConfig:(id)arg1;
