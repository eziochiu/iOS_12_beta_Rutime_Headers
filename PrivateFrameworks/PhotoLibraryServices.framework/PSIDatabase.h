...
@interface PSIDatabase : NSObject <PSIQueryDelegate, PSITableDelegate> {
...
- (unsigned long long)_inqAddAsset:(id)arg1 text:(id)arg2 identifier:(id)arg3 category:(short)arg4 owningGroupId:(unsigned long long)arg5 isInBatch:(bool)arg6;
- (unsigned long long)_inqAddCollection:(id)arg1 text:(id)arg2 identifier:(id)arg3 category:(short)arg4 owningGroupId:(unsigned long long)arg5 keyAssetUUID:(id)arg6 isInBatch:(bool)arg7;
...
- (id)_inqGroupsWithMatchingGroupIds:(struct __CFSet { }*)arg1 dateFilter:(id)arg2 matchingPredicateBlock:(id /* block */)arg3;
...
- (unsigned long long)_inqUpdateGroupAndSearchTableForText:(id)arg1 identifier:(id)arg2 category:(short)arg3 owningGroupId:(unsigned long long)arg4 shouldUpdateOwningGroupId:(bool)arg5;
- (void)_inqUpdateSearchTableWithGroupId:(unsigned long long)arg1 text:(id)arg2 category:(short)arg3 textIsSearchable:(bool)arg4;
