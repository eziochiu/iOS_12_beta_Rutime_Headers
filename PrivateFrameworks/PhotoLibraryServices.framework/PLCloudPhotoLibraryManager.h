...
@interface PLCloudPhotoLibraryManager : NSObject <CPLLibraryManagerDelegate, CPLResourceProgressDelegate, CPLStatusDelegate, PLBatterySaverWatcherDelegate, PLCloudChangeTrackerDelegate, PLCloudPersistentHistoryMigratorContext, PLCloudUserSessionHandling, PLForegroundObserver> {
