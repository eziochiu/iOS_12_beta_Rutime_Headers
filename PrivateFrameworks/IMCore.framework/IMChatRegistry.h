...
- (id)_ck_chatForHandles:(id)arg1 displayName:(id)arg2 lastAddressedHandle:(id)arg3 ignoresDisplayName:(bool)arg4 joinedChatsOnly:(bool)arg5 createIfNecessary:(bool)arg6;
