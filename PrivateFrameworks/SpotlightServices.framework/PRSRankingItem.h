...
- (void)populateTextFeatureValuesForProperty:(id)arg1 updatingBundleFeatureValues:(id)arg2 withEvaluator:(id)arg3 withContext:(struct prs_feature_population_ctx_t { struct __CFArray {} *x1; struct __CFArray {} *x2; struct __CFArray {} *x3; unsigned char x4; float x5[28]; float x6; float x7; float x8; float x9; unsigned int x10; unsigned long long x11; unsigned long long x12; long long x13; unsigned long long x14; }*)arg4 featureScoreInfo:(struct PRSL2FeatureScoreInfo { unsigned short *x1; float *x2; unsigned long long x3; unsigned long long x4; }*)arg5 fuzzyEvaluator:(id)arg6 propertyCanFuzzyMatch:(bool)arg7;
- (float)quality_score;
- (float)rawScore;
- (float)score;
...
- (void)updateBundleFeatures:(float*)arg1 withArrValues:(id)arg2 featureScoreInfo:(struct PRSL2FeatureScoreInfo { unsigned short *x1; float *x2; unsigned long long x3; unsigned long long x4; }*)arg3;
- (void)updateNumScoreDescriptorBundleFeatures:(float*)arg1 values:(id)arg2 feature:(unsigned long long)arg3 featureScoreInfo:(struct PRSL2FeatureScoreInfo { unsigned short *x1; float *x2; unsigned long long x3; unsigned long long x4; }*)arg4;
