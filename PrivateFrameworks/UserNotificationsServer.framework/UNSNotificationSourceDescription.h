...
@property (nonatomic, copy) NSString *watchLongLookLargeIconFile;
@property (nonatomic, copy) NSString *watchLongLookSmallIconFile;
...
- (void)setWatchLongLookLargeIconFile:(id)arg1;
- (void)setWatchLongLookSmallIconFile:(id)arg1;
...
- (bool)usesCloudKit;
- (id)watchLongLookLargeIconFile;
- (id)watchLongLookSmallIconFile;
