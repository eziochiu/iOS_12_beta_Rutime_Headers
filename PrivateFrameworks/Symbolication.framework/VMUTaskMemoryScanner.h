...
@property (nonatomic, readonly) NSMapTable *nsExactBlockVariableToClassInfoMap;
@property (nonatomic, readonly) NSMapTable *nsMallocBlockDescriptorToClassInfoMap;
...
- (id)nsExactBlockVariableToClassInfoMap;
- (id)nsMallocBlockDescriptorToClassInfoMap;
- (id)objectIdentifier;
