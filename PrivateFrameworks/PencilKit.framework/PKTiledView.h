...
@property (nonatomic, copy) NSMutableArray *cachedVisibleStrokesForDirtyDrawing;
@property (nonatomic, copy) NSMutableArray *cachedVisibleStrokesMinusHiddenStrokesForDirtyDrawing;
