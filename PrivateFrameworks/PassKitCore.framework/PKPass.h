...
@property (nonatomic, readonly) NSDictionary *allSemantics;
...
@property (readonly) bool npkHasTransitBalance;
@property (readonly) bool npkHasValidNFCPayload;
@property (readonly) bool npkIsEnroute;
...
@property (nonatomic, readonly) NSDictionary *semantics;
