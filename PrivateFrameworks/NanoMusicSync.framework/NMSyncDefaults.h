...
@property (nonatomic, copy) NSSet *addedPodcastEpisodes;
...
@property (nonatomic, copy) NSArray *availableGizmoPodcasts;
...
@property (nonatomic, copy) NSArray *gizmoPodcastFeedURLs;
...
- (void)setAddedPodcastEpisodes:(id)arg1;
...
- (void)setAvailableGizmoPodcasts:(id)arg1;
...
- (void)setGizmoPodcastFeedURLs:(id)arg1;
