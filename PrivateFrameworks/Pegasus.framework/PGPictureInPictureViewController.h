...
- (void)acquireInterfaceOrientationLockWithCompletionHandler:(id /* block */)arg1;
- (id)application;
- (id)contentContainer;
...
- (void)relinquishInterfaceOrientationLockWithCompletionHandler:(id /* block */)arg1;
...
- (void)setShowsChrome:(bool)arg1;
- (void)setShowsChrome:(bool)arg1 animated:(bool)arg2;
