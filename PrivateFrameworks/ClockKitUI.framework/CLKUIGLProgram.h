...
- (void).cxx_destruct;
- (id)initWithName:(id)arg1 gid:(unsigned int)arg2 uniforms:(struct CLKUIGLUniforms { int x1; int x2; int x3; int x4; int x5; int x6; int x7; })arg3;
- (id)name;
- (struct CLKUIGLUniforms { int x1; int x2; int x3; int x4; int x5; int x6; int x7; })uniforms;
- (void)use;
- (bool)validate;
