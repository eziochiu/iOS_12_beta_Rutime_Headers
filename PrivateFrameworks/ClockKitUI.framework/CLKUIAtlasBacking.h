...
@property (nonatomic, readonly) struct CLKUIAtlasBackingStructure { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned char x8; unsigned char x9; unsigned char x10; bool x11; } structure;
...
- (id)initWithUuid:(id)arg1 structure:(struct CLKUIAtlasBackingStructure { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned char x8; unsigned char x9; unsigned char x10; bool x11; })arg2 data:(id)arg3;
- (id)initWithUuid:(id)arg1 structure:(struct CLKUIAtlasBackingStructure { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned char x8; unsigned char x9; unsigned char x10; bool x11; })arg2 mmapFile:(id)arg3;
...
- (struct CLKUIAtlasBackingStructure { void *x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned char x8; unsigned char x9; unsigned char x10; bool x11; })structure;
- (id)uuid;
