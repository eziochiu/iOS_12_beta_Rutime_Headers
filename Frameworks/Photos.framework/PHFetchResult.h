...
@interface PHFetchResult : NSObject <NSCopying, NSFastEnumeration, PHObjectIDBackedFetchResult, PVFetchResultProtocol, PXDisplayAssetFetchResult, PXPeopleFetchResult> {
