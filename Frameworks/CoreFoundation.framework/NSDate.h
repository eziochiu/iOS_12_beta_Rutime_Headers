...
@interface NSDate : NSObject <AFSecurityDigestibleChunksProviding, ASDNotificationType, CKLParsedObject, CKRecordValue, FCKeyValueStoreCoding, HFPropertyListConvertible, NSCopying, NSSecureCoding, PQLValuable, TSCHChartGridValue>
