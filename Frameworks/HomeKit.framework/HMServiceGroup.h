...
@interface HMServiceGroup : NSObject <HFFavoritable, HFHomeKitObject, HFHomeStatusVisible, HFPrettyDescription, HFReorderableHomeKitObject, HFStateDumpSerializable, HFUserNotificationServiceSettingsProviding, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
