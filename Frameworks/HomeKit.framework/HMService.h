...
@interface HMService : NSObject <HFFavoritable, HFHomeContainedObject, HFHomeStatusVisible, HFPrettyDescription, HFReorderableHomeKitObject, HFRoomContextProviding, HFStateDumpSerializable, HFUserNotificationServiceSettingsProviding, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
