...
@interface HMAccessory : NSObject <HFFavoritable, HFHomeContainedObject, HFPrettyDescription, HFReorderableHomeKitObject, HFRoomContextProviding, HFStateDumpSerializable, HMAccessorySettingsContainer, HMControllable, HMFLogging, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
