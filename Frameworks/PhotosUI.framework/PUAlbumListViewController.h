...
@interface PUAlbumListViewController : UIViewController <PLNavigableAssetContainerListViewController, PUAlbumListTableViewCellDelegate, PUAlbumStreamActivityDelegate, PUCollectionViewReorderDelegate, PUSectionedGridLayoutDelegate, PUStackedAlbumControllerTransition, PUStackedAlbumTransitionDelegate, PXCloudFeedNavigating, PXCollectionsDataSourceManagerObserver, PXEditableNavigationTitleViewDelegate, PXNavigableSharedActivityViewController, PXPhotoLibraryUIChangeObserver, PXPlacesSnapshotFactoryDelegate, PXSettingsKeyObserver, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDropDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
