...
- (void)profileStateForCable:(void *)arg1 channel:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 8: unsigned char, unsigned char, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, MIDICIProfileState *, void*
