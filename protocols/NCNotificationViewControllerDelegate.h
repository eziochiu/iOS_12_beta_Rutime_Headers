...
- (bool)notificationViewController:(NCNotificationViewController *)arg1 shouldPerformNotificationCoalescingForNotificationRequest:(NCNotificationRequest *)arg2;
